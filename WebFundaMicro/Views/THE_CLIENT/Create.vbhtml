...
@Using (Html.BeginForm()) 
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.ID_CLIENT, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                <!-- 
                @Html.EditorFor(Function(model) model.ID_CLIENT, New With {.htmlAttributes = New With {.class = "form-control"}})
                
    @Html.ValidationMessageFor(Function(model) model.ID_CLIENT, "", New With {.class = "text-danger"})
                -->
            </div>
        </div>
    ...
    -->
                @Html.DropDownList("USR_CRUD_ACTION", Nothing, htmlAttributes:=New With {
                              .disabled = "disabled"
                          })
